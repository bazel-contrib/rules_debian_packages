...
def _debian_packages_toolchain_impl(ctx):
    ...
    debian_packagesinfo = MylangInfo(
    ...
    toolchain_info = platform_common.ToolchainInfo(
        debian_packagesinfo = debian_packagesinfo,
...
debian_packages_toolchain = rule(
    implementation = _debian_packages_toolchain_impl,
    attrs = {
    ...
    doc = """Defines a debian_packages compiler/runtime toolchain.
