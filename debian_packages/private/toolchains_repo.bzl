...
# By default all these toolchains are registered by the debian_packages_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:debian_packages_toolchain",
    toolchain_type = "@rules_debian_packages//debian_packages:toolchain_type",
)
""".format(
            platform = platform,
